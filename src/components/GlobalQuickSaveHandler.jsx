...
export const GlobalQuickSaveHandler = ({ children }) => {
    ...
    return (<>
      ...
      <Dialog open={isOpen} onClose={() => handleClose(false)} fullWidth>
        <CustomDialogTitle title="Quick Save" subTitle="Save your current tasks instantly" icon={<SaveAltRounded />} onClose={() => handleClose(false)}/>
