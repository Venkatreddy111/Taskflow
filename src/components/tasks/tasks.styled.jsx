...
export const TaskContainer = styled.div `
  ...
  border-radius: 30px;
  margin-top: 12px;
  transition: ${({ isDragging }) => (isDragging ? "none" : "border-left 0.2s, opacity 0.4s, filter 0.3s, box-shadow 0.3s")};
  ...
  /* text-shadow: ${({ backgroundColor, glow, done }) => glow && !done ? `0 0 2px ${getFontColor(backgroundColor)}78` : "none"}; */
...
export const SearchInput = styled(TextField) `
  ...
  & .MuiOutlinedInput-root {
    ...
    &.Mui-focused {
      ...
      box-shadow: ${({ theme }) => isDark(theme.secondary) ? "0 0 0 4px #1a1e4a7f" : `0 0 0 4px ${theme.primary}64`};
    }
