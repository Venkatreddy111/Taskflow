...
import { DataObjectRounded, DeleteForeverRounded, DescriptionRounded, ErrorOutlineRounded, ExpandMoreRounded, FileDownload, RefreshRounded, } from "@mui/icons-material";
import { Accordion, AccordionDetails, AccordionSummary, Alert, Button, Dialog, DialogActions, DialogContent, Typography, } from "@mui/material";
    ...
    render() {
        if (this.state.hasError) {
          ...
          <h2>
            ...
            <StyledLink translate="no" href="https://github.com/Venkatreddy111/Taskflow/issues">
              Github Issues
            </StyledLink>
            .
          </h2>
          ...
          <pre>
            ...
            <Button variant="outlined" sx={{ ml: "6px", my: "18px", p: "12px 20px", borderRadius: "14px" }} onClick={() => {
          ...
          <Dialog open={this.state.openClearDialog} onClose={this.handleCloseDialog}>
            <CustomDialogTitle title="Clear Data" subTitle="This action cannot be undone." icon={<DeleteForeverRounded />} onClose={this.handleCloseDialog}/>
            <DialogContent>
...
const ErrorExpandIcon = styled(ExpandMoreRounded) `
  ...
  font-size: 32px;
`;
const UnstyledButton = ({ ...props }) => (<Button variant="outlined" size="large" {...props}/>);
