...
function App() {
    ...
    useEffect(() => {
        ...
        const updateNestedProperties = (userObject, defaultObject) => {
            if (!userObject)
            ...
            Object.keys(defaultObject).forEach((key) => {
                ...
                if (key === "favoriteCategories" && Array.isArray(userObject.favoriteCategories)) {
                    userObject.favoriteCategories = userObject.favoriteCategories.filter((id) => userObject.categories.some((cat) => cat.id === id));
                    return;
                }
    ...
    return (<MuiThemeProvider theme={createCustomTheme(getMuiTheme().palette.primary.main, getMuiTheme().palette.secondary.main, isDarkMode(user.darkmode, systemTheme, getMuiTheme().palette.secondary.main)
            ? "dark"
            : "light")}>
